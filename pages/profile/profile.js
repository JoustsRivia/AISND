...
Page({
  ...
  onSelect(e) {
    ...
    if (key === 'cert') { wx.navigateTo({ url: '/pkg-cert/pages/list/list?scope=all' }); return; }
    if (key === 'cert-expire') { wx.navigateTo({ url: '/pkg-cert/pages/list/list?scope=expiring' }); return; }
